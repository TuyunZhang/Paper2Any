          ...
          <div className="mt-2 space-y-2">
            {pptPath && (
              <>
                ...
                >
                  <CheckCircle2 size={14} />
                  <span>PPT 下载 (如无响应请复制下方链接)</span>
                </button>

                <div className="text-[11px] text-gray-300 bg-black/30 border border-white/10 rounded-md px-2 py-1.5">
                  <div className="font-semibold text-gray-200">如果下载失败，请复制下面链接到浏览器地址栏打开：</div>
                  <div className="mt-1 break-all text-primary-200 select-all cursor-text font-mono text-[10px] leading-tight p-1 bg-black/20 rounded">
                    {pptPath}
                  </div>
                </div>
              </>
            ...
            {svgPreviewPath && (
              <div className="rounded-lg border border-white/10 bg-black/30 p-2">
                <p className="text-[11px] text-gray-300 mb-1 font-semibold">技术路线图预览 (PNG)</p>
                <div className="w-full max-h-64 overflow-auto bg-white/5 rounded-md flex items-center justify-center p-2 border border-white/5">
                  <img
                    src={svgPreviewPath}
                    alt="技术路线图预览"
